            ...
            <div className='py-[20px] px-[18px] flex flex-col gap-[12px]'>
                <div className=''>
                    <ul className='mobile-lists'>
                        <li>
                            <Button size='link' variant='ghost'>
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#262D2999" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                                User data
                            </Button>
                ...
                {isAuth ? (
                    ...
                    <Button onClick={() => { setIsLogin(true); close((prev: any) => !prev) }}>
                        Sign in
                    </Button>
                )}
            </div>
